...
## 7. MVP1.2、MVP1.3、MVP1.4、MVP1.5 与长期规划顺延清单
...
MVP1.5 承接 ContextPack 的上游证据增强能力：
...
明珠公寓真实 PDF 已完成完整矩阵生成和质量门禁验收，最终质量报告通过且无剩余质量问题。下一步建议进入 MVP1.2：商务/资格 ContextPack 预览、生成、确认和准备度门禁；MVP1.3 承接基于 ContextPack 的结构化草稿生成和审阅导出；MVP1.5 再接企业资料 RAG、Embedding/Rerank 和候选证据推荐。技术标、净化产品选型、图纸/OCR、多 Agent 和报价辅助进入长期规划，不再继续往 MVP1.1 塞新功能。
